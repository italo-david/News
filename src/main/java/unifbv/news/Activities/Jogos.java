...
public class Jogos extends Ciencia
{
    ...
    //RSS links
    private final String RSS_link="http%3A%2F%2Frss.uol.com.br%2Ffeed%2Fjogos.xml";
    ...
    private AsyncTask<String,String,String> loadRSS() {
        final AsyncTask<String,String,String> loadRSSAsync = new AsyncTask<String, String, String>() {
            ...
            ProgressDialog mDialog = new ProgressDialog(Jogos.this);
