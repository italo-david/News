...
public class Tecnologia extends Ciencia
{
    ...
    //RSS links
    private final String RSS_link="http%3A%2F%2Frss.nytimes.com%2Fservices%2Fxml%2Frss%2Fnyt%2FTechnology.xml";
    ...
    private AsyncTask<String,String,String> loadRSS() {
        final AsyncTask<String,String,String> loadRSSAsync = new AsyncTask<String, String, String>() {
            ...
            ProgressDialog mDialog = new ProgressDialog(Tecnologia.this);
